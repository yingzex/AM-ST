set -x
cp configs/cbert_amazon_Ling.config run.config
PROCESSED_DATA_DIR=processed_data_Ling
python preprocess_Ling.py raw_data/amazon/sentiment.train.0 label amazon.train.0 amazon $PROCESSED_DATA_DIR
python preprocess_Ling.py raw_data/amazon/sentiment.dev.0 label amazon.dev.0 amazon $PROCESSED_DATA_DIR
python preprocess_Ling.py raw_data/amazon/sentiment.test.0 label amazon.test.0 amazon $PROCESSED_DATA_DIR
python preprocess_Ling.py raw_data/amazon/sentiment.train.1 label amazon.train.1 amazon $PROCESSED_DATA_DIR
python preprocess_Ling.py raw_data/amazon/sentiment.dev.1 label amazon.dev.1 amazon $PROCESSED_DATA_DIR
python preprocess_Ling.py raw_data/amazon/sentiment.test.1 label amazon.test.1 amazon $PROCESSED_DATA_DIR
