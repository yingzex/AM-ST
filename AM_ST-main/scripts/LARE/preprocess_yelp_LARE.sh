set -x
cp configs/cbert_yelp_LARE.config run.config
PROCESSED_DATA_DIR=processed_data_LARE
python preprocess_LARE.py raw_data/yelp/sentiment.train.0 label yelp.train.0 yelp $PROCESSED_DATA_DIR
python preprocess_LARE.py raw_data/yelp/sentiment.dev.0 label yelp.dev.0 yelp $PROCESSED_DATA_DIR
python preprocess_LARE.py raw_data/yelp/sentiment.test.0 label yelp.test.0 yelp $PROCESSED_DATA_DIR
python preprocess_LARE.py raw_data/yelp/sentiment.train.1 label yelp.train.1 yelp $PROCESSED_DATA_DIR
python preprocess_LARE.py raw_data/yelp/sentiment.dev.1 label yelp.dev.1 yelp $PROCESSED_DATA_DIR
python preprocess_LARE.py raw_data/yelp/sentiment.test.1 label yelp.test.1 yelp $PROCESSED_DATA_DIR
